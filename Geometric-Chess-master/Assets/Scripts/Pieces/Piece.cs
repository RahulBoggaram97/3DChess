...
*/
	...
	public void findThenode(float x, float y, float z)
    {
		Vector3 newNodePos = new Vector3(x, y, z);

		Node newNode = GameManager.Instance.Grid.GetNodeAt(newNodePos);

		Debug.Log("NodeFound :" + newNode.name + " and its position is :" + newNode.rowChess + newNode.colChess);
	...
	public void Pickup() {
		Highlight();
		ZeroGravity();
		MoveBy(new Vector3(0,1.5f,0), null);
	}
