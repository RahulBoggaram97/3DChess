...
public class Rules : MonoBehaviour {
	...
	public static bool CheckKing(GCPlayer player, Node checkedByNode, Node checkedNode) {
		if (checkedNode.Piece.PieceType == PieceType.CROSS) {
			...
			checkedNode.Piece.Node.HighlightCheck();
	...
	public static bool IsCheckMove(GCPlayer player, Piece piece, Node tNode, bool modify) {
		...
		if(checkedBy != null) 
		Debug.Log(" the check by var is : " + checkedBy.ToString() + " and the player is : " + checkedBy.ChessCoords);
		player.ClearCheck();
		...
		if (player.IsChecked) {
			...
			if (checkedBy != null)
				Debug.Log("after doing the computation,  the check by var is : " + checkedBy.ToString() + " and the player is : " + checkedBy.ChessCoords);
			return true;
		}
