...
{
    public class tournamentChessBoard : MonoBehaviourPunCallbacks
    {
        [Header("Art Stuff")]
       ...
       public  endGameApiCAller matchEnderApiCalls;
        ...
        void sendMatchData(int team)
        {
            ...
            {
                if (team == 0)
                    matchEnderApiCalls.sendTournamentMatchStat(matchEnderApiCalls.MatchWonConstString);
                else
                    matchEnderApiCalls.sendTournamentMatchStat(matchEnderApiCalls.MatchLossConstString);
            }
