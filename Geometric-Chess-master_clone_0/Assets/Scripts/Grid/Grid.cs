...
public class Grid : MonoBehaviour {
	...
	IEnumerator SpawnPieces() {
		...
		SpawnPiece(new GridCoords(0,1),piecesPrefabs[5], 90,  p1T); //p1 rect
		SpawnPiece(new GridCoords(0,6),piecesPrefabs[5], 90, p1T); //p1 rect
		SpawnPiece(new GridCoords(7,1),piecesPrefabs[5], 270, p2T); //p2 rect
		SpawnPiece(new GridCoords(7,6),piecesPrefabs[5], 270, p2T); //p2 rect
		//*/
