...
public class singlePlayerChessBoard : MonoBehaviour
{
    ...
    private chessPiecePuzzle tappedPiece;
    ...
    private void SetCamera()
    {
        if (isWhiteTurn)
        {
            currentCamera.transform.position = new Vector3(0.1382576f, 10.04575f, -5.12f);
            currentCamera.transform.rotation = Quaternion.Euler(65f, 0f, 0f);
        }
        else
        {
            currentCamera.transform.position = new Vector3(0.1382576f, 11f, 3.53f);
            currentCamera.transform.rotation = Quaternion.Euler(107f, 0f, 0f);
        }
